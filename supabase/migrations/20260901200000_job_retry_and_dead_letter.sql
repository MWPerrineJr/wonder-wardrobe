-- Retry metadata for survey email and AI enrichment so a transient outage
-- recovers without duplicate sends or unbounded model spend.
...
-- Existing failed/blocked rows become eligible on the next job run.

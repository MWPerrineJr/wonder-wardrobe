  ...
  return (
    ...
    >
      <div className="mb-5 flex items-start gap-2 rounded-lg border border-border-subtle bg-surface-variant/50 px-3 py-2.5 text-label-sm text-on-surface-variant">
        ...
        <p>
          These insights and recommendations are generated by AI and may be incomplete. Review
          them alongside your business records and judgment before making decisions.
        </p>
      </div>

  ...
  head: () => ({
    meta: [
      { title: "My Schedule — The Standing Chair" },
      {
        name: "description",
        content:
          "Personal calendar view for providers — manage appointments and Google Calendar sync.",
      },
      { property: "og:title", content: "My Schedule — The Standing Chair" },
      {
        property: "og:description",
        content: "Personal calendar with appointments, breaks and Google Calendar sync.",
      },

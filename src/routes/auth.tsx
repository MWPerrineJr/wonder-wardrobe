  ...
  head: () => ({
    meta: [
      { title: "Sign in — The Standing Chair" },
      {
        name: "description",
        content:
          "Sign in or create your The Standing Chair account to book providers and manage appointments.",
      },
    ],
  }),
  component: AuthPage,
...
function AuthPage() {
  ...
  const [mode, setMode] = useState<"sign_in" | "sign_up">(
    initialMode === "sign_up" ? "sign_up" : "sign_in",
  );
          ...
          {!hydrated || loading ? (
            ...
            <div className="glass-panel rounded-xl p-6 md:p-8 flex flex-col gap-4">
              ...
              <p className="text-body-md text-on-surface-variant">
                ...
                <span className="font-bold text-on-surface">{pendingConfirmation}</span>. Click it
